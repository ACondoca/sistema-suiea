...
<body>
  ...
  <?php include "../component/header-user.php"; ?>
                  ...
                  <div class="main-sidebar">
                    ...
                    <section>
                      ...
                      <?php
                        if($rowInst['area'] == "Ensino Médio"){
                          $identificador = $rowInst['id_instituicao'];
                          $sql = "SELECT curso_medio.nome, curso_medio.vagas, curso_medio.inscricao_val, curso_medio.matricula_val, curso_medio.descricao, curso_medio.id, curso_medio.imagem FROM curso_medio INNER JOIN instituicao ON curso_medio.id_inst = instituicao.id_instituicao WHERE instituicao.id_instituicao = $identificador";
                          $stmt = $pdo->prepare($sql);
                          $stmt->execute();
                            if ($stmt->rowCount() != 0) {
                              $count = 1; 
