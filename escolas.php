    ...
    <body>
		...
		<div class="blog-content">
			...
			<div class="container-fluid">
				...
				<?php
					$sql = "SELECT * FROM instituicao INNER JOIN inst_medio ON instituicao.id_instituicao = inst_medio.id";
					$stmt = $pdo->query($sql);
					if($stmt->rowCount() > 0){?>
				...
				<?php
					$sql = "SELECT * FROM instituicao INNER JOIN inst_superior ON instituicao.id_instituicao = inst_superior.id";
					$stmt = $pdo->query($sql);
					if($stmt->rowCount() > 0){?>
