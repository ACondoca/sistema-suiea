				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-fun">
							...
							<div class="content">
								<span class="counter"><?php echo $total_registrations; ?></span>
						...
						<?php
							...
							if($stmt->rowCount() > 0){
								...
								while($rowM = $stmt->fetch()){
									$sql = "SELECT * FROM instituicao INNER JOIN mensagem ON instituicao.id_instituicao = mensagem.id_inst";
									$stmt = $pdo->query($sql);
									if($row = $stmt->fetch()){
										...
										<div class="testimonial-description">
											<div class="testimonial-info">
												...
												<div class="testimonial-person">
													...
													<h4><?php echo $row['localizacao']; ?></h4>
													<?php 	
									}
									?>
